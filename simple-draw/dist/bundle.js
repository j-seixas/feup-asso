...
class EventListener {
    constructor(doc, view, fileExporter) {
        ...
        this.exportTextButton.addEventListener("click", (e) => {
            ...
            let data = fs_1.readFileSync('D:\SimpleDraw(2).txt');
            console.log(data);
        });
...
},{"./exportFactory":5,"./view":13,"file-saver":15,"fs":14}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const shape_1 = require("./shape");
...
class ExportFactory {
    //inputTypes = new Map<FileFormat, FileImporter>();
    constructor() {
